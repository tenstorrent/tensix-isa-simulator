...
using ronin::iss::whb0::core::Tensix;
using ronin::iss::whb0::core::ThreadType;
using ronin::iss::whb0::core::ThreadSync;
...
void ThreadContext::reset() {
    for (uint32_t i = 0; i < 32; i++) {
        ...
        m_cb_src_format[i] = uint32_t(DataFormat::Float32);
        m_cb_dst_format[i] = uint32_t(DataFormat::Float32);
    }
}
...
void ThreadContext::write_globals() {
    cb_interface = m_cb_interface;
    unpack_src_format = m_cb_src_format;
    unpack_dst_format = m_cb_dst_format;
    pack_src_format = m_cb_src_format;
    pack_dst_format = m_cb_dst_format;
}
...
void ThreadBase::write_globals() {
    ...
    l1_buffer = get_l1_buffer_ptr();

    m_thread_context->write_globals();
}
...
uint32_t *l1_buffer = nullptr;

CBInterface *cb_interface = nullptr;;
const uint32_t *unpack_src_format = nullptr;
const uint32_t *unpack_dst_format = nullptr;
const uint32_t *pack_src_format = nullptr;
const uint32_t *pack_dst_format = nullptr;
